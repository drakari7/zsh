#----------------------------------------------------------------------------------
# Copied from https://github.com/bew/dotfiles/blob/1e1117fec1a043027a40e27434acf85d5fdeb00d/zsh/rc/mappings.zsh#L543
#----------------------------------------------------------------------------------
# Implements a way to clear the terminal while preserving scrollback
